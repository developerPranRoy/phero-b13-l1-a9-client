...
export default function Footer() {
  return (
    <footer className="border-t border-gray-200 dark:border-gray-700 mt-auto bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-500 text-sm">
              Your trusted platform for booking expert tutors and learning
              sessions online.
            </p>
          </div>
          <div>
